...
public class MongoDBConnection implements DBConnection {
	...
	public Set<String> getCategories(String businessId) {
		Set<String> set = new HashSet<>();
		FindIterable<Document> iterable = db.getCollection("restaurants").find(new Document("business_id", businessId));

		iterable.forEach(new Block<Document>() {// if our database is correct,
	...
	public Set<String> getBusinessId(String category) {
		Set<String> set = new HashSet<>();
		FindIterable<Document> iterable = db.getCollection("restaurants").find(regex("categories", category));// regular
																												// expression
																												// pattern
																												// matching
		iterable.forEach(new Block<Document>() {
